                      ...
                      builder: (context) => AlertDialog(
                        ...
                        content: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                HeroIcon(HeroIcons.clipboard, size: 18, color: Colors.orange),
                                SizedBox(width: 4),
                                RichText(
                                  text: TextSpan(
                                    children: [
                            ...
                            Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                HeroIcon(HeroIcons.clipboardDocument, size: 18, color: Colors.orange),
                                SizedBox(width: 4),
                                Expanded(
                                  child: RichText(
                                    text: TextSpan(
                            ...
                            Row(
                              children: [
                                HeroIcon(HeroIcons.clipboardDocumentList, size: 18, color:Colors.orange),
                                SizedBox(width: 4),
                                RichText(
                                  text: TextSpan(
                                    children: [
                            ...
                            Row(
                              children: [
                                HeroIcon(HeroIcons.calendarDays, size: 18, color:Colors.orange),
                                SizedBox(width: 4),
                                RichText(
                                  text: TextSpan(
                                    children: [
                            ...
                            Row(
                              children: [
                                HeroIcon(HeroIcons.clock, size: 18, color:Colors.orange),
                                SizedBox(width: 4),
                                RichText(
                                  text: TextSpan(
                                    children: [
                            ...
                            Row(
                              children: [
                                HeroIcon(HeroIcons.bellAlert, size: 18, color: Colors.orange),
                                SizedBox(width: 4),
                                Obx(() => RichText(
                                  text: TextSpan(
                                    children: [
